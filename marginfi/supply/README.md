...
A FastMCP server for supplying assets to MarginFi via Dialect Blink.

## Features

- Simple MCP interface for MarginFi supply operations
...
1. Clone the repository:
   ...
   cd dialect-mcps/marginfi/supply
   ```
...
```bash
fastmcp install main.py --name "MarginFi Supply"
```

### Example Requests

The MCP exposes a single `marginfi_supply` tool which accepts the following parameters:
