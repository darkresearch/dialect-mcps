...
A FastMCP server for withdrawing funds from Lulo via Dialect Blink.

## Features

- Simple MCP interface for Lulo withdrawals
...
```bash
fastmcp install main.py --name "Lulo Withdraw"
```

### Example Requests

The MCP exposes a single `lulo_withdraw` tool which accepts the following parameters:
