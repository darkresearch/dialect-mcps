...
def jupiter_dao_stake(amount: float, tx_sender_pubkey: str) -> DaoStakeResponse:
    """
    ...
    try:
        ...
        return DaoStakeResponse(success=True, result=response.json())
        ...
        return DaoStakeResponse(success=False, error=error_message)
    except Exception as e:
        return DaoStakeResponse(success=False, error=f"Unexpected error: {str(e)}")
