...
def jupiter_dao_claim(tx_sender_pubkey: str) -> DaoClaimResponse:
    """
    ...
    try:
        ...
        return DaoClaimResponse(success=True, result=response.json())
        ...
        return DaoClaimResponse(success=False, error=error_message)
    except Exception as e:
        return DaoClaimResponse(success=False, error=f"Unexpected error: {str(e)}")
